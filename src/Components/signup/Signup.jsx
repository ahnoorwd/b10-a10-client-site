    ...
    const handlesignup = (e) => {
        ...
        CreateUser(email, password)
            ...
            .catch((error) => {
                ...
                //     seterror("The email is already taken, please use a new email.");
                // } else {
                    ...
                    <form onSubmit={handlesignup} className="card-body space-y-4">
                        ...
                        <div className="form-control">
                            ...
                            <input
                                ...
                                className="input input-bordered bg-white/20 text-white placeholder-gray-300 focus:ring-2 focus:ring-purple-500"
                                required
                            />
                        </div>
                        ...
                        <div className="form-control">
                            ...
                            <input
                                ...
                                className="input input-bordered bg-white/20 text-white placeholder-gray-300 focus:ring-2 focus:ring-blue-500"
                                required
                            />
                        </div>
                        ...
                        <div className="form-control">
                            ...
                            <input
                                ...
                                className="input input-bordered bg-white/20 text-white placeholder-gray-300 focus:ring-2 focus:ring-red-500"
                                required
                            />
                        </div>
                        ...
                        <div className="form-control">
                            ...
                            <input
                                ...
                                className="input input-bordered bg-white/20 text-white placeholder-gray-300 focus:ring-2 focus:ring-green-500"
                                required
                            />
                        </div>
