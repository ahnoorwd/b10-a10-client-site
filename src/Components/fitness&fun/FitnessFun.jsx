...
//   return (
//     <div className="bg-gradient-to-r mt-4 from-purple-500 to-pink-400 p-6 rounded-xl shadow-lg">
...
//       <FaDumbbell className="text-4xl text-white mb-4" />
//       <h3 className="text-white text-2xl font-bold">Fitness & Fun</h3>
//       <p className="text-white mt-2">Engage in exciting workouts and fun activities for a healthier life.</p>
...
//           <p className="text-white">Exercise guide content goes here...</p>
//         </div>
//       )}
//     </div>
//   );
